...
/*
這個解法好酷喔，他把原先的我應該要取什麼來達到 max subarray 換成:
「如果整條 array 都取，我應該不要取什麼來達到 max subarray」，我不取的東西當然就是連續最小的 subarray
一開始我會擔心會不會
[3 -2 -3 1 -3 7]
總和最小的連續陣列是 [-2 -3]，而他為了取 1 而也多取了 -3 之類的
但在這個例子中，總和最小的連續陣列是 [-2 -3 1 -3]
這題題目要求至少要取一個，所以如果總和最小的連續陣列就是整條，那我就用原本的答案就好
*/
